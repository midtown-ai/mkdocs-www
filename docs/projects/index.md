...
-   :fontawesome-solid-building: __Python__
    ...
    [:fontawesome-solid-arrow-right:{ .bouncing-horizontally } Explore python](/projects/python/index.md)
...
-   :fontawesome-solid-user-large: __DeepRacer__
    ...
    [:fontawesome-solid-arrow-right:{ .bouncing-horizontally } Let's DeepRacer!](/projects/deepracer/index.md)
